...
const Testimonials = () => {
  return (
    ...
    initial = {{opacity:0, x:-200}}
      ...
      viewport={{once: true}}
    className='container mx-auto py-10 lg:px-32 px-6 md:px-20 overflow-hidden' id='Testimonials'>
      ...
      <p className='text-color text-gray-500 mb-12 max-w-80 mx-auto'>Real Stories from Those Who Found Home with Us</p>

      <div className='flex flex-wrap gap-6 justify-center'>
        {testimonialsData.map((testimonial, index) => (
          <div key={index} className='max-w-[400px] border shadow-lg rounded px-8 py-12 text-center'>
            <img src={testimonial.image} alt={testimonial.name} className='w-20 h-30 rounded-full mx-auto mb-4' />
