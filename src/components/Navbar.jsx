  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'>
      <div className='container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent'>
        ...
        <button className='hidden md:block bg-white px-8 py-2 rounded-full'>Login/Signup</button>
        <img onClick = {()=> setShowMobileMenu(true)} src={assets.menu_icon} alt='' className='md:hidden w-7' ></img>
        ...
        <div className={`md:hidden ${showMobileMenu? "fixed w-full": "h-0 w-0"} right-0 top-0 bottom-0 overflow-hidden`}>
          ...
          <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium bg-white transtition-all '>
