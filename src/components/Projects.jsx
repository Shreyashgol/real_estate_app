  ...
  return (
    ...
    >
      ...
      <p className="text-center text-gray-500 mb-8 max-w-80 mx-auto">
        Crafting Spaces, Exploring Legaices for your comfort
      </p>
      ...
      <div className="flex justify-end items-center mb-8">
        <button
          ...
          onClick={prevProject}
        >
          <img src={assets.left_arrow} alt="Previous" className="w-10 h-10" />
        </button>
          ...
          {projectsData.map((project, index) => (
            ...
            >
              <img
                src={project.image}
                alt={project.title}
                className="w-full h-auto object-cover rounded-t-lg mb-14"
              />
